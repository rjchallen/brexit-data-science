...
Select 'vote2015r_label','q1Answer','unweighted','unweighted_percent','demographic_weighted_percent','combined_weighted_percent' union
Select 
	p.vote2015r_label,
	p.q1_label,
	COUNT(*) as unweighted,
...
INTO OUTFILE '/tmp/question1byVote2015.csv'
FIELDS TERMINATED BY ','
ENCLOSED BY '"'
LINES TERMINATED BY '\n';
;